...
75 10          ReportSize(16), 
95 02          ReportCount(2),
14             Logical Minimum(0), <-- Changed from 15 00
26 e0 2e      Logical Maximum(12000),
34             Physical Minimum(0), <-- Changed from 35 00
...
44             Physical Maximum(0), <-- Changed from 45 01 to 44 (removes physical units) 
64             Units(None), <-- Changed from 65 00 
75 01          Report Size(1), 
...
18             Usage Minimum(0),  <-- Changed from 19 00
29 10          Usage Maximum(16),
25 10          Logical Maximum(16),
75 05          Report Size(5), 
80             Input(Data, Array, No Null Position), <-- Changed from 81 00
...
44             Physical Maximum(0), <-- Changed from 45 01 to 44 (removes physical units) 
64             Units(None), <-- Changed from 65 00
a4             Push <-- Added so physical units can be cancelled at the end
75 01          Report Size(1), 
